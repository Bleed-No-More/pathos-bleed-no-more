...
public:
	...
	// Get resolution schema font set
	const font_set_t* GetSchemaResolutionFont( const Char* pstrsetname );
...
public:
	...
	// Bg surface for Game UI
	CGameUISolidSurface* m_pBackground;
