...
void CL_InitInput( void )
{
	...
	g_pCvarMousePitchUp = cl_engfuncs.pfnCreateCVarCallback(CVAR_FLOAT, FL_CV_CLIENT, "m_pitchup", "89", "Mouse pitch turn min limit.", CL_ViewPitchUpDownCvarCallback);
	g_pCvarMousePitchDown = cl_engfuncs.pfnCreateCVarCallback(CVAR_FLOAT, FL_CV_CLIENT, "m_pitchdown", "89", "Mouse pitch turn max limit.", CL_ViewPitchUpDownCvarCallback);
